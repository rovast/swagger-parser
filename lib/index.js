...
var validateSpec = require("./validators/spec"),
    normalizeArgs = require("json-schema-ref-parser-kill-circular/lib/normalize-args"),
    util = require("./util"),
    Options = require("./options"),
    maybe = require("call-me-maybe"),
    ono = require("ono"),
    $RefParser = require("json-schema-ref-parser-kill-circular"),
    dereference = require("json-schema-ref-parser-kill-circular/lib/dereference");
